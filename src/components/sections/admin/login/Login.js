    ...
    <div className="min-h-screen bg-gray-900 flex items-center justify-center px-4">
      ...
      >
        ...
        <input
          ...
          className="w-full mb-4 px-4 py-2 rounded bg-white/20 text-white placeholder-white focus:outline-none focus:ring-2 focus:ring-purple-500"
          required
        />
        ...
        <input
          ...
          className="w-full mb-6 px-4 py-2 rounded bg-white/20 text-white placeholder-white focus:outline-none focus:ring-2 focus:ring-purple-500"
          required
        />
